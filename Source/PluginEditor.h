...
/**
*/
class KlanghabitatConnectorAudioProcessorEditor  : public AudioProcessorEditor, public OSCReceiver::Listener<OSCReceiver::MessageLoopCallback>, public Timer, public juce::Slider::Listener
{
public:
...
private:
    ...
    juce::ToggleButton AutoConnectButton   { "autoconnect" };
